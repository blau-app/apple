...
struct Superdapp_Token: Sendable {
    ...
    var balance: Superdapp_Balance {
        get { _balance ?? Superdapp_Balance() }
        set { _balance = newValue }
    }

    /// Returns true if `balance` has been explicitly set.
    var hasBalance: Bool { _balance != nil }
    /// Clears the value of `balance`. Subsequent reads from it will return its default value.
    mutating func clearBalance() { _balance = nil }
...
struct Superdapp_TokenBundle: Sendable {
    ...
    var hasTitle: Bool { _title != nil }
    /// Clears the value of `title`. Subsequent reads from it will return its default value.
    mutating func clearTitle() { _title = nil }
...
private let _protobuf_package = "superdapp"
...
extension Superdapp_GetTokenBundlesRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            switch fieldNumber {
            case 1: try decoder.decodeRepeatedStringField(value: &evmPublicKeys)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !evmPublicKeys.isEmpty {
            try visitor.visitRepeatedStringField(value: evmPublicKeys, fieldNumber: 1)
        }
...
extension Superdapp_TokenBundleResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeRepeatedMessageField(value: &tokenBundles)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !tokenBundles.isEmpty {
            try visitor.visitRepeatedMessageField(value: tokenBundles, fieldNumber: 1)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension Superdapp_Token: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 2: try decoder.decodeSingularEnumField(value: &erc)
            case 3: try decoder.decodeSingularStringField(value: &address)
            case 4: try decoder.decodeSingularInt32Field(value: &chainID)
            case 5: try decoder.decodeSingularStringField(value: &name)
            case 6: try decoder.decodeSingularStringField(value: &symbol)
            case 7: try decoder.decodeSingularInt32Field(value: &decimals)
            case 8: try decoder.decodeRepeatedEnumField(value: &actions)
            case 9: try decoder.decodeSingularMessageField(value: &_balance)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if erc != .erc20 {
            try visitor.visitSingularEnumField(value: erc, fieldNumber: 2)
        }
        if !address.isEmpty {
            try visitor.visitSingularStringField(value: address, fieldNumber: 3)
        }
        if chainID != 0 {
            try visitor.visitSingularInt32Field(value: chainID, fieldNumber: 4)
        }
        if !name.isEmpty {
        ...
        if decimals != 0 {
            try visitor.visitSingularInt32Field(value: decimals, fieldNumber: 7)
        }
        if !actions.isEmpty {
            try visitor.visitPackedEnumField(value: actions, fieldNumber: 8)
        }
...
extension Superdapp_Balance: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            switch fieldNumber {
            case 1: try decoder.decodeSingularStringField(value: &id)
            case 2: try decoder.decodeSingularDoubleField(value: &value)
            case 3: try decoder.decodeSingularDoubleField(value: &fiat)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if fiat.bitPattern != 0 {
            try visitor.visitSingularDoubleField(value: fiat, fieldNumber: 3)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension Superdapp_TokenBundle: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 3: try decoder.decodeRepeatedMessageField(value: &self.in)
            case 4: try decoder.decodeRepeatedMessageField(value: &out)
            case 5: try decoder.decodeRepeatedEnumField(value: &actions)
            case 6: try decoder.decodeSingularMessageField(value: &_balance)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if !out.isEmpty {
            try visitor.visitRepeatedMessageField(value: out, fieldNumber: 4)
        }
        if !actions.isEmpty {
